...
public class logonUser {
	...
	public long executar() throws Exception{
		...
		SoapObject request = new SoapObject("http://192.168.0.1:19120/services/sccsystem",
				"logonUser");
		...
		AndroidHttpTransport httpTransport = new AndroidHttpTransport("http://192.168.0.1:19120/services/sccsystem?wsdl");
