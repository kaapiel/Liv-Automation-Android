...
public class Constants {
	...
	public static String mobileWebProperties = "./utilitarios/properties/xpathMobileWeb.properties";
	public static String mobileAndroidProperties = "./utilitarios/properties/xpathMobileAndroid.properties";
	public static String mobileiOSProperties = "./utilitarios/properties/xpathMobileiOS.properties";
	public static String CTS = "./utilitarios/properties/CTs.properties";
	public static String logPath = "./appium.log";
