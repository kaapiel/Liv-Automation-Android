...
public class Constants {
    ...
    public static final String URL_FORGOT_PASSWORD = "https://m.pontoslivelo.com.br/mobile/secure/minha-conta/esqueci-senha";
    public static final String URL_REQUEST_CODE = "http://m.pontoslivelo.com.br/activate";
    public static final String URL_TERM = "http://m.pontoslivelo.com.br/mobile/livelo/livelo/o-programa/regulamento";

    private static final String URL_ACTIVATE_ACCOUNT_DEV = "http://m-dev.pontoslivelo.com.br/#mdlActivateAccount";
    private static final String URL_ACTIVATE_ACCOUNT_PROD = "http://m.pontoslivelo.com.br/#mdlActivateAccount";
    public static final String URL_ACTIVATE_ACCOUNT = endpointAprovation ?  URL_ACTIVATE_ACCOUNT_DEV : URL_ACTIVATE_ACCOUNT_PROD;

    public static final String URL_EDIT_ACCOUNT_PROD = "https://m.pontoslivelo.com.br/mobile/secure/myaccount/editProfile.jsp";
    ...
    public static final class JiraParser{
        public final static String JIRA_GET = "https://jira.pontoslivelo.com.br/rest/api/2/search?jql=reporter%20in(t27000023,gabriel.fraga,marllon.souza)&maxResults=5&startAt=2&project=Livelo&fields=key,summary,issuetype,created,priority,status,customfield_10015,components,resolution,reporter,assignee";
        public final static String JIRA_GET2 = "https://jira.pontoslivelo.com.br/rest/api/2/search?jql=reporter%20in(t27000023,gabriel.fraga,marllon.souza)&maxResults=5&startAt=2&project=Livelo";
        public final static String JIRA_GET3 = "https://10.150.197.3/rest/api/2/search";
        public final static String JIRA_GET4 = "https://jira.pontoslivelo.com.br/rest/api/2/search";
