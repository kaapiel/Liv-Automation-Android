 ...
 */
public class SummaryMonthBusiness {
    private SummaryMonthActivity.OnSummaryMonthBusinessListener onSummaryMonthBusinessListener;
    private Context context;

    public SummaryMonthBusiness(SummaryMonthActivity.OnSummaryMonthBusinessListener onSummaryMonthBusinessListener, Context context) {
        this.onSummaryMonthBusinessListener = onSummaryMonthBusinessListener;
    ...
    public void callServiceGetListUserTransactions() {
        ...
        request.setDateFrom(DateUtil.formatDateForService(DateUtil.getDateBeforeMonths(6)));
    ...
    private SummaryBusiness.OnServiceUserTransactionListener getOnServiceUserTransactionListener() {
        final SummaryBusiness.OnServiceUserTransactionListener onServiceUserTransactionListener = new SummaryBusiness.OnServiceUserTransactionListener() {
            ...
            public void onGetUserTransactionSuccess(UserTransactionsResponse response) {
                ...
                onSummaryMonthBusinessListener.onSummaryMonthBusinessSuccess(response);
            }

            @Override
            public void onGetUserTransactionFail(LiveloException exception) {
                onSummaryMonthBusinessListener.onSummaryMonthBusinessFail(exception);
            }
        };
